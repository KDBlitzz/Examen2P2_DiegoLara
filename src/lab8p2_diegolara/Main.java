...
// drag puede ser 800 o 400 metros
    ...
    public Main() {
        ...
        AdminCircuitos circu = new AdminCircuitos("./Circuitos.cct");

        aj.cargarArchivo();
        DefaultComboBoxModel model2 = new DefaultComboBoxModel(aj.getList().toArray());
        cb_user.setModel(model2);
        cb_simuser.setModel(model2);
        cb_simuser2.setModel(model2);
        cb_modjugador.setModel(model2);
        cb_moduser.setModel(model2);
        ...
        acs.cargarArchivo();
        DefaultComboBoxModel model3 = new DefaultComboBoxModel(acs.getList().toArray());
        cb_conce2.setModel(model3);
        cb_conce.setModel(model3);

        circu.cargarArchivo();
        DefaultComboBoxModel model4 = new DefaultComboBoxModel(circu.getList().toArray());
//        cb_sim.setModel(model4);
        conc = acs.getList();
        carros = ac.getList();
        circ = circu.getList();
    }
    ...
    private void initComponents() {
        ...
        cb_simuser = new javax.swing.JComboBox<>();
        cb_simuser2 = new javax.swing.JComboBox<>();
        cb_carrouser = new javax.swing.JComboBox<>();
        cb_carrouser2 = new javax.swing.JComboBox<>();
        ...
        jTabbedPane2.addTab("Instalacion de Partes", jPanel15);

        cb_carreras.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Drag", "Off-road", "Circuito" }));
        cb_carreras.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_carrerasActionPerformed(evt);
            }
        });

        cb_simuser.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cb_simuserItemStateChanged(evt);
            }
        });
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel14Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cb_sim, 0, 300, Short.MAX_VALUE)
                            .addComponent(cb_carreras, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel14Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(cb_simuser, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 213, Short.MAX_VALUE)
                        .addComponent(cb_simuser2, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel14Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(cb_carrouser, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cb_carrouser2, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cb_simuser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cb_simuser2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cb_carrouser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cb_carrouser2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jb_confirmarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jb_confirmarMouseClicked
        if (tf_admin.getText().equals("admin") && pf_pass.getText().equals("admin")) {
            ...
            AdminCons acs = new AdminCons("./Consesionaria.cns");
            acs.cargarArchivo();
            DefaultComboBoxModel model2 = new DefaultComboBoxModel(acs.getList().toArray());
            cb_conce.setModel(model2);
            Admin.pack();
    ...
    private void jb_crearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jb_crearMouseClicked
        AdminJugador aj = new AdminJugador("./Usuarios.usr");
        DefaultComboBoxModel cb = (DefaultComboBoxModel) cb_user.getModel();
        ...
        if (2023 - year <= 12) {
            ...
            jugadores.add(j);
            for (jugador o : jugadores) {
                cb.addElement(o);
            }
            cb_user.setModel(cb);
            cb_modjugador.setModel(cb);
            cb_moduser.setModel(cb);
    ...
    private void jb_comprarcMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jb_comprarcMouseClicked
        if (jugadores.get(cb_user.getSelectedIndex()).getCash() < carros.get(jt_compra.getSelectedRow()).getPrecio()) {
            ...
            aj.getList().get(cb_user.getSelectedIndex()).getPlayercars().add(carros.get(jt_compra.getSelectedRow()));
            aj.getList().get(cb_user.getSelectedIndex()).setCash(jugadores.get(cb_user.getSelectedIndex()).getCash() - carros.get(jt_compra.getSelectedRow()).getPrecio());
            com = new Comprapg();
...
//            DefaultComboBoxModel model = (DefaultComboBoxModel) cb_carrouser.getModel();
//            model.addElement(jugadores.get(cb_carrouser.getSelectedIndex()).getPlayercars());
//            cb_carrouser.setModel(model);

        }
    }//GEN-LAST:event_jTabbedPane2StateChanged

    private void cb_carrerasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_carrerasActionPerformed
        DefaultComboBoxModel model = (DefaultComboBoxModel) cb_sim.getModel();
        model.removeAllElements();
        if (cb_carreras.getSelectedItem().toString().equals("Drag")) {
            for (Circuitos c : circ) {
                if (c.getTipo().equals("Drag")) {
                    model.addElement(c.getTipo());
                }
                if (c.getTipo().equals("Circuito")) {
                    model.addElement(c.getTipo());
                }
            }

        }
        if (cb_carreras.getSelectedItem().toString().equals("Off-road")) {
            for (Circuitos c : circ) {
                if (c.getTipo().equals("Off-road")) {
                    model.addElement(c.getTipo());
                }
            }

        }
        if (cb_carreras.getSelectedItem().toString().equals("Circuito")) {
            for (Circuitos c : circ) {
                if (c.getTipo().equals("Circuito")) {
                    model.addElement(c.getTipo());
                }
    ...
    }//GEN-LAST:event_cb_carrerasActionPerformed

    private void cb_simuserItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_simuserItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cb_simuserItemStateChanged
    ...
    private javax.swing.JComboBox<String> cb_carrouser;
    private javax.swing.JComboBox<String> cb_carrouser2;
    ...
    private javax.swing.JComboBox<String> cb_simuser;
    private javax.swing.JComboBox<String> cb_simuser2;
...
//                cb_simuser.setModel(model);
//                cb_simuser2.setModel(model);
//                cb_modjugador.setModel(model);
//                cb_moduser.setModel(model);
//            }
//            if (cont == 200) {
